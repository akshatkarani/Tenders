...
urlpatterns = [
    ...
    path('user/dashboard/<str:username>',
         UserDashboard.as_view(), name='user-dashboard'),
    path('user/dashboardads/<str:username>',
         UserDashboardAds.as_view(), name='user-dashboardads'),
